# 📘 Digital Design Projects (SystemVerilog)
...
- **Modulus-48 Counter (8-bit)** — custom counter with rollover logic
- **Frequency Divider (÷2)**
- **Frequency Divider (÷4)**
...
- **Universal Shift Register (5-bit)** — parallel load, shift-left, shift-right, hold
...
- **Mealy Sequence Detector** — detects `001` using a 3-state FSM
...
### **5. Memory & Storage**
- **Single-Clock FIFO (64-byte)** — synchronous FIFO with write/read logic and testbench

---

### **6. Arithmetic & Logic**
- **ALU** — performs multiple arithmetic and logic operations via opcode selection
